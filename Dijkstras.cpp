...
{  // Dijkstras();
    ...
    Metro.addEdge("Seelampur","Welcome",1.6);
    Metro.addEdge("Welcome","Shaheed Sthal",1.2);
    ...
    Metro.addEdge("Noida Electronic City","Dwarka Sector-21",1.5);
    Metro.addEdge("Vaishali","Yamuna Bank",1.7);
    ...
    Metro.addEdge("Mandi House","Janpath",1.4);
    Metro.addEdge("Janpath","Central Secretariat",1.3);
    ...
    Metro.addEdge("Jangpura","Brig. Hoshiar Singh",0.7);
    ...
    Metro.addEdge("Millenium City Centre Gurugram","Samaypur Badli",2.3);
    ...
    if(res==false)
    {
        ...
        cout<<"Invalid Station Entered"<<endl;
        return 0;
    }
    ...
    switch(i){
        ...
        cin>>details;
        system("cls");
        cout<<"The Payment was successfully made"<<endl;
        break;
        }
